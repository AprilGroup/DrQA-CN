...
parser.add_argument('--input', type=str, default='../../data/datasets/mba_def_org_location.json')
parser.add_argument('--output', type=str, default='../../data/retriever/test_data/mba_def_org_location.txt')
