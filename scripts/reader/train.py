...
from mbaqa.reader import utils, vector, config, data
from mbaqa.reader import DocReader
from mbaqa import DATA_DIR as DRQA_DATA
...
# Defaults
DATA_DIR = DRQA_DATA
MODEL_DIR = '/home/zrx/projects/MbaQA/tmp/drqa-models/'
...
def add_train_args(parser):
    ...
    files.add_argument('--train-file', type=str,
                       default='mba_def-train-preprocessed-ltp.txt',
                       help='Preprocessed train file')
    files.add_argument('--dev-file', type=str,
                       default='mba_def-train-preprocessed-ltp.txt',
                       help='Preprocessed dev file')
    files.add_argument('--dev-json', type=str, default='mba_def.json',
                       help=('Unprocessed dev file to run validation '
                             'while training on'))
    files.add_argument('--embed-dir', type=str, default=EMBED_DIR,
                       help='Directory of pre-trained embedding files')
    files.add_argument('--embedding-file', type=str,
                       default='glove_format_100m_200d.txt',
